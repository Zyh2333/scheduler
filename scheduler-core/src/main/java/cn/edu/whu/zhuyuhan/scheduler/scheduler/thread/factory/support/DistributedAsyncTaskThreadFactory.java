 ...
 * Date: 2021/8/1 16:07
 **/
public class DistributedAsyncTaskThreadFactory extends AbstractThreadFactory {

    private static final ThreadGroup THREAD_GROUP = new ThreadGroup("distributedAsyncThreadGroup");
